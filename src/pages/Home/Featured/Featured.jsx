...
const Featured = () => {
  return (
    <div className="featured-item bg-fixed text-white pt-8 my-20">
      ...
      ></SectionTItle>
      <div className="md:flex justify-center items-center overflow-y-auto bg-slate-500 bg-opacity-60 pb-20 pt-12 px-36">
        <div>
        ...
        <div className="md:ml-10">
          ...
          <button className="btn btn-outline hover:bg-none border-0 border-b-2 mt-4 text-white">
            Order Now
          </button>
        </div>
      </div>
